...
try:
    ...
    # user
    result = cursor.execute("""insert into user values(100,"asd123","ardaonal@gmail.com","ankara,cankaya","5055821811");""")
    result = cursor.execute("""insert into user values(101,"asd123","besteguney@gmail.com","ankara,cankaya","5055856811");""")
    result = cursor.execute("""insert into user values(102,"asd123","farukguney@gmail.com","ankara,cankaya","5325856811");""")
    result = cursor.execute("""insert into user values(104,"asd123","kaanatesel@gmail.com","ankara,cankaya","5327756811");""")
    result = cursor.execute("""insert into user values(105,"asd123","ahmetmehmet@gmail.com","istanbul","5321156811");""")
    ...
    # driving_license
    result = cursor.execute("""insert into driving_license values(100,55667788,"B1",STR_TO_DATE("07-25-2012","%m-%d-%Y"));""")
    result = cursor.execute("""insert into driving_license values(101,33667788,"A1",STR_TO_DATE("03-16-2018","%m-%d-%Y"));""")
    result = cursor.execute("""insert into driving_license values(102,33117788,"C1",STR_TO_DATE("12-21-2019","%m-%d-%Y"));""")
    ...
    # customer
    result = cursor.execute("""insert into customer values(100, STR_TO_DATE("08-24-2001","%m-%d-%Y"),"Turkey","Premium","Arda Onal");""")
    result = cursor.execute("""insert into customer values(101, STR_TO_DATE("11-17-2001","%m-%d-%Y"),"Turkey","Gold","Beste Guney");""")
    result = cursor.execute("""insert into customer values(102, STR_TO_DATE("03-06-2001","%m-%d-%Y"),"Turkey","Silver","Faruk Guney");""")
    ...
    # vehicle
    result = cursor.execute("""insert into vehicle values("06AY6527", "available",300,"Civic","Honda",250000,3,40000,"Automatic",104,1);""")
    result = cursor.execute("""insert into vehicle values("06TD1845", "available",400,"320D","BMW",850000,3,70000,"Automatic",104,1);""")
    result = cursor.execute("""insert into vehicle values("34GL3100", "available",200,"Polo","Volkswagen",170000,3,65000,"Manual",104,1);""")
    result = cursor.execute("""insert into vehicle values("06REK121", "onsale",200,"Polo","Volkswagen",120000,13,120000,"Manual",null,null);""")
    ...
    # reservation
    result = cursor.execute("""insert into reservation values(1, STR_TO_DATE("12-17-2021","%m-%d-%Y"), STR_TO_DATE("12-27-2021","%m-%d-%Y"), "not_accepted", 3000, 100, 106, "true", "asdas", "Full Coverage", "06AY6527", null, null);""")
